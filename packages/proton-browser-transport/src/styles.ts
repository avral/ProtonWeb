...
.%prefix%-inner {
    background: ${walletType == 'proton' ? protonBackgroundColor : anchorBackgroundColor};
    color: white;
    margin: 20px;
    border-radius: 20px;
    position: relative;
...
.%prefix%-logo {
    width: 100%;
    height: 50px;
    background-image: ${walletType == 'proton' ? protonLogo : anchorLogo};
